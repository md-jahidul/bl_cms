...
@endsection
@section('action')
    <a href="{{ route('section-create', [$id]) }}" class="btn btn-success  round btn-glow px-2"><i class="la la-plus"></i>
        Add Partner
    </a>
@endsection
@section('content')
                    ...
                    <table class="table table-striped table-bordered" role="grid" aria-describedby="Example1_info" style="">
                        ...
                        @foreach($productSections as $section)
                            <tr>
                                ...
                                <td class="pt-2">
                                    <a href="{{ route('component-list', [$section->id]) }}"
                                       class="btn-sm btn-outline-primary border">Components</a>
                                </td>
                                <td class="action" width="8%">
                                    <a href="{{ url("partners/$section->id/edit") }}" role="button" class="btn btn-outline-info border-0"><i class="la la-pencil" aria-hidden="true"></i></a>
