            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row skin skin-square">
                        ...
                        {{--                            <fieldset>--}}
                        {{--                                <input type="checkbox" id="popular" name="sorting_filters" value="popular"--}}
                        {{--                                       data-label="Popular" @if(in_array('popular', $sort_filters)) checked @endif>--}}
                        ...
                        <div class="col-md-3 col-sm-12">
                            <fieldset>
                                <input type="checkbox" id="price_low_high" value="price_low_high" name="sorting_filters"
                                       ...
                                       @if(in_array('price_low_high', $sort_filters)) checked @endif>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <fieldset>
                                <input type="checkbox" id="price_high_low" value="price_high_low" name="sorting_filters"
                                       ...
                                       @if(in_array('price_high_low', $sort_filters)) checked @endif>
    ...
    <script>
        $(function () {
            let saveSortFilter = function (param) {
                return $.ajax({
                    url: '{{route('recharge-pack.filter.sort.save')}}',
                    method: 'post',
                    data: param
                });
            }
