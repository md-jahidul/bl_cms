            ...
            <div class="container-fluid">
                <div class="row px-1 pt-1 bg-white">
                    ...
                    <div class="form-group col-md-4 {{ $errors->has('android_version_code') ? ' error' : '' }}">
                        ...
                        <input type="text" name="android_version_code"  class="form-control" placeholder="Enter Version Code" value="@if(isset($shortcut)){{$shortcut->android_version_code}} @elseif(old("android_version_code")) {{old("android_version_code")}} @endif">
                        <div class="help-block"></div>
                    ...
                    <div class="form-group col-md-4 {{ $errors->has('ios_version_code') ? ' error' : '' }}">
                        ...
                        <input type="text" name="ios_version_code"  class="form-control" placeholder="Enter Version Code" value="@if(isset($shortcut)){{$shortcut->ios_version_code}} @elseif(old("ios_version_code")) {{old("ios_version_code")}} @endif">
                        <div class="help-block"></div>
                        <span class="text-info"><strong><i class="la la-info-circle"></i></strong> Version code should be Hyphen-separated value. Example: 10-99</span>
                        <div class="help-block"></div>
