                    ...
                    <table class="box-1">
                        <tr>
                            <td>
                                ...
                                <div class="box-txt-2">{{ $data['summary']['idea_title'] }}</div>
                            </td>
                            <td>
                                <div class="box-txt-1">Industry</div>
                                <div class="box-txt-2">{{ $data['summary']['industry'] }}</div>
                            </td>
                        </tr>
                    </table>
                        ...
                        @foreach($data['attachments'] as $attachment)
                            <div class="item">
                                <a href="{{ config('filesystems.file_base_url') . $attachment['file_path'] }}">
                                    ...
                                    <div class="right">
                                        <span class="attach-2">{{ $attachment['file_name'] }}</span>
                                        <span class="attach-1">File Size:<span style="font-weight: 600; color: #212121; margin-left:5px">{{ $attachment['file_size'] }}</span></span>
                                    </div>
                                </a>
                            </div>
                        @endforeach
