...
@section('card_name', 'Startup Stage Edit')
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ url('bl-labs/startup-stage') }}">Startup Stage List</a></li>
    <li class="breadcrumb-item active"> Startup Stage Edit</li>
@endsection
@section('action')
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ url("bl-labs/startup-stage/$data->id") }}" method="POST" novalidate enctype="multipart/form-data">
                            @csrf
                            {{method_field('PUT')}}
                            <div class="form-body">
                                <div class="offset-2">
