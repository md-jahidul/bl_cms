    ...
    <div class="card">
        <div class="card-content collapse show">
            <div class="card-body card-dashboard">
                ...
                <div class="card-body card-dashboard">
                    <form id="product_form" role="form" action="{{ route('explore-c.update', $exploreC->id) }}" method="POST" novalidate enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('title_en') ? ' error' : '' }}">
                                ...
                                <input type="text" name="title_en" id="title_en" class="form-control required" placeholder="Enter explore name in English"
                                       value="{{ old("title_en") ? old("title_en") : $exploreC->title_en }}">
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('title_bn') ? ' error' : '' }}">
                                ...
                                <input type="text" name="title_bn" id="title_bn" class="form-control required" placeholder="Enter explore name in Bangla"
                                       value="{{ old("title_bn") ? old("title_bn") : $exploreC->title_bn }}">
                                <div class="help-block"></div>
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <textarea type="text" name="short_desc_en" id="vat" class="form-control summernote_editor" placeholder="Enter description in English"
                                          >{{ old("short_desc_en") ? old("short_desc_en") : $exploreC->short_desc_en }}</textarea>
                                <div class="help-block"></div>
                            </div>
                            ...
                            <div class="form-group col-md-6 ">
                                ...
                                <textarea type="text" name="short_desc_bn" id="vat" class="form-control summernote_editor" placeholder="Enter description in Bangla"
                                          >{{ old("short_desc_bn") ? old("short_desc_bn") : $exploreC->short_desc_bn }}</textarea>
                                <div class="help-block"></div>
                            </div>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('start_date') ? ' error' : '' }}">
                                ...
                                <div class='input-group'>
                                    <input type='text' class="form-control" name="start_date" id="start_date"
                                           value="{{ old("start_date") ? old("start_date") : $exploreC->start_date }}"
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('end_date') ? ' error' : '' }}">
                                ...
                                <input type="text" name="end_date" id="end_date" class="form-control"
                                       ...
                                       value="{{ old("end_date") ? old("end_date") : $exploreC->end_date }}" autocomplete="off">
                                <div class="help-block"></div>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('img_name_en') ? ' error' : '' }}">
                                ...
                                <input type="text" name="img_name_en" id="img_name_en" class="form-control" placeholder="Enter explore name in English"
                                       value="{{ old("img_name_en") ? old("img_name_en") : $exploreC->img_name_en }}">
                                <div class="help-block"></div>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('img_name_bn') ? ' error' : '' }}">
                                ...
                                <input type="text" name="img_name_bn" id="img_name_bn" class="form-control" placeholder="Enter explore name in Bangla"
                                       value="{{ old("img_name_bn") ? old("img_name_bn") : $exploreC->img_name_bn }}">
                                <div class="help-block"></div>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('img_alt_en') ? ' error' : '' }}">
                                ...
                                <input type="text" name="img_alt_en" id="img_alt_en" class="form-control" placeholder="Enter explore name in English"
                                       value="{{ old("img_alt_en") ? old("img_alt_en") : $exploreC->img_alt_en }}">
                                <div class="help-block"></div>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('img_alt_bn') ? ' error' : '' }}">
                                ...
                                <input type="text" name="img_alt_bn" id="img_alt_bn" class="form-control" placeholder="Enter explore c's name in Bangla"
                                       value="{{ old("img_alt_bn") ? old("img_alt_bn") : $exploreC->img_alt_bn }}">
                                <div class="help-block"></div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="file"
                                    ...
                                    data-default-file="{{ asset($exploreC->image) }}"/>
                                @if($errors->has('image'))
                                    <div class="help-block">  {{ $errors->first('image') }}</div>
                                @endif
                            </div>
                            <div class="form-group col-md-6">
                                <label for="img">Image (Mobile)</label>
                                <input type="file"
                                    id="img"
                                    name="image_mobile"
                                    class="dropify_image"
                                    data-allowed-file-extensions="png jpg gif"
                                    data-default-file="{{ asset($exploreC->image_mobile) }}"/>
                            ...
                            <div class="form-group col-md-6 {{ $errors->has('color') ? ' error' : '' }}">
                                ...
                                <input type="color" name="color"  class="form-control" value="{{ $exploreC->color }}">
                            </div>
                            ...
                            {{-- <div class="form-group col-md-6 {{ $errors->has('display_order') ? ' error' : '' }}">
                                ...
                                <input type="number" min="0" name="display_order" id="display_order" class="form-control" placeholder="Enter explore c's order"
                                       value="{{ old("display_order") ? old("display_order") : $exploreC->display_order }}">
                                <div class="help-block"></div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="status" value="1" id="active" {{ $exploreC->status == 1 ? 'checked' : '' }}>
                                    <label for="active" class="mr-1">Active</label>

                                    <input type="radio" name="status" value="0" id="inactive" {{ $exploreC->status == 0 ? 'checked' : '' }}>
                                    <label for="inactive">Inactive</label>
                                </div>
                            </div>

                            <slot id="explore_c_landing_btn" data-offer-type="" class="">
                                @include('admin.explore-c.multi_button_section', $exploreC->multiple_attributes ?? [])
                            </slot>
