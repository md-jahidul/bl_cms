...
@section('title', 'Create Health Hub Service')
@section('card_name', 'Create Health Hub Service')
@section('breadcrumb')
    <li class="breadcrumb-item active">Create Health Hub Service</li>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form"
                              action="{{ route('health-hub-feature-service.store') }}"
                              method="POST"
                              class="form"
