...
{{--                            <div id="append_div"--}}
{{--                                 class="col-md-6 {{ $imageInfo->user_type != "segment_wise_banner" ? 'show' : 'hidden' }}">--}}
{{--                                @if(isset($imageInfo))--}}
...
{{--                                                    <select class="feed-cat-list form-control"--}}
{{--                                                            name="other_attributes[feed_cat_slug]" required>--}}
{{--                                                        @foreach($feedCategories as $feedCategory)--}}
{{--                                                            <option value="{{ $feedCategory->slug }}"--}}
{{--                                                                    data-id="{{ $feedCategory->id }}"--}}
...
{{--                                                </td>--}}
{{--                                                <td>--}}
{{--                                                    <input class="form-control" name="action_url_or_code"--}}
{{--                                                           value="{{ $data->action_url_or_code }}" type="text">--}}
{{--                                                </td>--}}
