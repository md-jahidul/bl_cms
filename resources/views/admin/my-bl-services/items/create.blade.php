    ...
    <section id="form-control-repeater">
        <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    <div class="card-body">
                        <form novalidate class="form row" action="{{route('my-bl-services.items.store')}}"
                            ...
                            <div class="form-group col-12 mb-2 file-repeater">
                                <div class="row mb-1">
                                    ...
                                    {{--                                            @if(!($service_information->component_for == 'non_bl' || $service_information->component_for == 'non_bl_offer'))--}}
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <input
                                                ...
                                                placeholder="Title En" name="title _en">
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <small class="text-danger"> @error('tags') {{ $message }} @enderror </small>
                                        <div class="help-block"></div>
                                    </div>
                                </div>
