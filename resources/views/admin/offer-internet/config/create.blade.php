...
@section('title', 'Internet Pack Filter Configuration')
@section('card_name', "Internet Pack Filter")
@section('breadcrumb')
            ...
            <div class="card-content">
                <div id="settings_panel" role="tablist" aria-multiselectable="true">
                    <div class="card collapse-icon accordion-icon-rotate">
                        ...
                        @include('admin.offer-internet.config._partials.price_config_form')
                        <!---------------  Internet Config ------------------------------------>

                        @include('admin.offer-internet.config._partials.internet_config_form')

                        <!---------------  Validation Config ------------------------------------>
                       @include('admin.offer-internet.config._partials.validity_config_form')
