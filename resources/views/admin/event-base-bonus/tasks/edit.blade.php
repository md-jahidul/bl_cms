...
@endsection
@section('action')
    <a href="{{ url('event-base-bonus/tasks') }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i>
        Cancel </a>
@endsection
@section('content')
                ...
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form id="feed-form" novalidate class="form row"
                              action="{{url('event-base-bonus/tasks/'.$task['id'])}}" enctype="multipart/form-data"
                              method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="row mb-1">
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <input required maxlength="100"
                                               ...
                                               value="{{ $task['title'] }}" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <input required maxlength="100"
                                               data-validation-required-message="Title is required"
                                               data-validation-maxlength-message="Title can not be more then 200 Characters"
                                               value="{{ $task['title_bn'] }}" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <input required maxlength="20"
                                               ...
                                               value="{{ $task['btn_text'] }}" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <input required maxlength="20"
                                               data-validation-required-message="Btn Text is required"
                                               data-validation-maxlength-message="Btn Text can not be more then 200 Characters"
                                               value="{{ $task['btn_text_bn'] }}" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <input required maxlength="100"
                                               ...
                                               value="{{ $task['recurrence_number'] }}" type="number"
                                               class="form-control" placeholder="Recurrence Number"
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <input required maxlength="30"
                                               ...
                                               value="{{ $task['reward_text'] }}" type="text" class="form-control"
                                    ...
                                    <div class="form-group col-md-6 {{ $errors->has('reward_prepaid') ? ' error' : '' }}">
                                        ...
                                        <select class="product_code" name="reward_product_code_prepaid"
                                                data-url="{{ url('product-core/match') }}" required
                                                data-validation-required-message="Please select Reward prepaid">
                                    ...
                                    <div class="form-group col-md-6 {{ $errors->has('reward_postpaid') ? ' error' : '' }}">
                                        ...
                                        <select class="product_code" name="reward_product_code_postpaid"
                                                data-url="{{ url('product-core/match') }}" required
                                                data-validation-required-message="Please select Reward Postpaid">
                                            <option value="">Select product code</option>
                                            @foreach($products as $productCodes)
                                    ...
                                    <div class="form-group col-md-6 {{ $errors->has('event') ? ' error' : '' }}">
                                        ...
                                        <select class="product_code" name="event"
                                                data-url="{{ url('product-core/match') }}" required
                                                data-validation-required-message="Please select event">
                                            <option value="">Select product code</option>
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <div class="form-group {{ $errors->has('status') ? ' error' : '' }}">
                                            <input type="radio" name="tracking_type" value="1"
                                                   id="input-radio-15" {{ $task['tracking_type'] == 1 ? 'checked' : '' }}>
                                            <label for="input-radio-15" class="mr-3">Automatic</label>
                                            <input type="radio" name="tracking_type" value="0"
                                                   id="input-radio-16" {{ $task['tracking_type'] == 0 ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <div class="form-group {{ $errors->has('status') ? ' error' : '' }}">
                                            <input type="radio" name="status" value="1"
                                                   id="input-radio-15" {{ $task['status'] == 1 ? 'checked' : '' }}>
                                            <label for="input-radio-15" class="mr-3">Active</label>
                                            <input type="radio" name="status" value="0"
                                                   id="input-radio-16" {{ $task['status'] == 0 ? 'checked' : '' }}>
                                    ...
                                    <div id="image-input" class="form-group col-md-6 mb-2">
                                        <div class="form-group">
                                            ...
                                            <input type="file" id="image_url" name="icon_image" class="dropify_image"
                                                   data-height="80" data-default-file="{{ asset($task['icon_image']) }}"
                                                   data-allowed-file-extensions="png jpg gif json"/>
                                            <div class="help-block"></div>
...
@push('page-css')
    ...
    <link rel="stylesheet"
          href="{{ asset('app-assets/vendors/css/bootstrap-multiselect/bootstrap-multiselect.min.css') }}">
...
@push('page-js')
    ...
    <script type="text/javascript"
            src="{{ asset('app-assets/vendors/js/bootstrap-multiselect/bootstrap-multiselect.min.js') }}"></script>
