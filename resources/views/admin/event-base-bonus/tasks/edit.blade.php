    ...
    <div class="card">
        <div class="card-content collapse show">
            <div class="card-body card-dashboard">
                <div class="card-body card-dashboard">
                    <form id="feed-form" novalidate class="form row" action="{{url('event-base-bonus/tasks/'.$task['id'])}}" enctype="multipart/form-data" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="form-group col-12 mb-2 file-repeater">
                            <div class="row mb-1">
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <input required maxlength="100" data-validation-required-message="Title is required" data-validation-maxlength-message="Title can not be more then 200 Characters" value="{{ $task['title'] }}" type="text" class="form-control" placeholder="Enter title in English" name="title">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <input required maxlength="100" data-validation-required-message="Title is required" data-validation-maxlength-message="Title can not be more then 200 Characters" value="{{ $task['title_bn'] }}" type="text" class="form-control" placeholder="Enter title in Bangla" name="title_bn">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <textarea rows="4" required name="description" class="form-control" placeholder="Enter description in English">{{ $task['description'] }}</textarea>
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <textarea rows="4" required name="description_bn" class="form-control" placeholder="Enter description in Bangla">{{ $task['description_bn'] }}</textarea>
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <input required maxlength="20" data-validation-required-message="Btn Text is required" data-validation-maxlength-message="Btn Text can not be more then 200 Characters" value="{{ $task['btn_text'] }}" type="text" class="form-control" placeholder="Enter Btn Text in English" name="btn_text">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <input required maxlength="20" data-validation-required-message="Btn Text is required" data-validation-maxlength-message="Btn Text can not be more then 200 Characters" value="{{ $task['btn_text_bn'] }}" type="text" class="form-control" placeholder="Enter Btn Text in Bangla" name="btn_text_bn">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <input required maxlength="100" data-validation-required-message="Recurrence Number is required" data-validation-maxlength-message="Recurrence Number can not be more then 100" value="{{ $task['recurrence_number'] }}" type="number" class="form-control" placeholder="Recurrence Number" name="recurrence_number">
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <input required maxlength="30" data-validation-required-message="Reward text is required" data-validation-maxlength-message="Reward text can not be more then 200 Characters" value="{{ $task['reward_text'] }}" type="text" class="form-control" placeholder="Enter Reward text" name="reward_text">
                                ...
                                <div class="form-group col-md-6 mb-2 d-none">
                                    ...
                                    <div class="form-group {{ $errors->has('status') ? ' error' : '' }}">
                                        <input checked type="radio" name="tracking_type" value="1" id="input-radio-15" {{ $task['tracking_type'] == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-group col-md-6 mb-2">
                                    ...
                                    <div class="form-group {{ $errors->has('status') ? ' error' : '' }}">
                                        <input type="radio" name="status" value="1" id="input-radio-15" {{ $task['status'] == 1 ? 'checked' : '' }}>
                                        <label for="input-radio-15" class="mr-3">Active</label>
                                        <input type="radio" name="status" value="0" id="input-radio-16" {{ $task['status'] == 0 ? 'checked' : '' }}>
    ...
    $(document).ready(function() {
        ...
        $('.dropify_image').dropify({
            messages: {
                ...
                'remove': 'Remove',
                'error': 'Choose correct Image/Json File file'
            },
            error: {
