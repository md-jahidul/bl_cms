...
@section('title', 'Create Campaign Section')
@section('card_name', 'Create Campaign Section')
@section('breadcrumb')
    <li class="breadcrumb-item active">Create Campaign Section</li>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form"
                              action="{{ route('mybl-campaign-section.store') }}"
                              method="POST"
                              class="form"
