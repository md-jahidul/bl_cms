...
@section('breadcrumb')
    <li class="breadcrumb-item active">New Campaign Modality Campaign List</li>
@endsection

@section('action')
    {{-- @if(!$cashBackCampaigns->count()) --}}
        <a href="{{route('new-campaign-modality.create')}}" class="btn btn-primary round btn-glow px-2"><i
                class="la la-plus"></i>
            Create Campaign
        </a>
    {{-- @endif --}}
