                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <button id="repeater-button" type="button"
                                            class="btn-sm btn-success cursor-pointer float-right plus_button {{ $campaign->deno_type == "all_deno" ? 'd-none' : "" }}">
                    ...
                    <div class="form-group col-md-4 cash_back_amount_for_product">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="number" name="campaign_details[`+index+`][numbers_of_get_bonus]" class="form-control"
                                   placeholder="Please Select numbers of get bonus product">
                        </div>
                        @php
                            $productType = '<span class="text-success">(Prepaid) </span>'
                        @endphp
                ...
                <slot>
                    ...
                    <slot class="selective_deno" >
                        <div class="form-group col-md-4 }}">
                            ...
                            <div class='input-group'>
                                <input type='number' class="form-control" name="campaign_details[`+index+`][recharge_amount]" placeholder="Please select min recharge amount" autocomplete="off"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-4 }}">
                            ...
                            <div class='input-group'>
                                <input type='number' class="form-control" name="campaign_details[`+index+`][max_recharge_amount]" placeholder="Please select Max recharge amount" autocomplete="off"/>
                            </div>
                        </div>
