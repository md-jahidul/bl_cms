                            ...
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 col-xs-12 mt-2">
                                        ...
                                        <input value="{{ $offer->banner_title_en }}" class="form-control" name="banner_title_en">
                                    </div>
                                    <div class="col-md-6 col-xs-12 mt-2">
                                        <label>Banner Title (BN)</label>
                                        <input value="{{ $offer->banner_title_bn }}" class="form-control" name="banner_title_bn">
                                    </div>

                                    <div class="col-md-6 col-xs-12 mt-2">
                                        <label>Banner Short Text (EN)</label>
                                        <textarea rows="4" class="form-control" name="banner_desc_en">{{ $offer->banner_desc_en }}</textarea>
                                    </div>
                                    <div class="col-md-6 col-xs-12 mt-2">
                                        <label>Banner Short Text (BN)</label>
                                        <textarea rows="4" class="form-control" name="banner_desc_bn">{{ $offer->banner_desc_en }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="form-group col-md-6 {{ $errors->has('tag_en') ? ' error' : '' }}">
                                        ...
                                        >{{ $offer->searchableFeature->tag_en ?? '' }}</textarea>
                                    ...
                                    <div class="form-group col-md-6 {{ $errors->has('tag_bn') ? ' error' : '' }}">
                                        ...
                                        <textarea type="text" name="tag_bn" id="alt_text" class="form-control" rows="4"
                                                  placeholder="Enter keywords bn">{{ $offer->searchableFeature->tag_bn ?? '' }}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 {{ $errors->has('url_slug') ? ' error' : '' }} col-xs-12  mb-1">
                                        ...
                                        <input type="text" class="form-control slug-convert" name="url_slug" placeholder="URL" value="{{ $offer->url_slug }}">
                                        <small class="text-info">
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                        ...
                                        <input type="text" class="form-control slug-convert" required name="url_slug_bn" placeholder="URL" value="{{ $offer->url_slug_bn }}">
                                        <small class="text-info">
