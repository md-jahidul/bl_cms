<div class="card">
    <div class="card-content collapse show">
        <div class="card-body card-dashboard">
            <h4 class="pb-1"><strong>Other Offer Categories</strong>
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-xs-12 sample_photo">
                    ...
                    <img style="border: 1px solid #ddd;" src="{{asset('app-assets/images/roaming/other-offer-category.png')}}" width="100%">
                ...
                <div class="col-md-5 col-xs-12 cat_update_form" style="display: none;">
                    ...
                    <hr>
                    <form method="POST" action="{{ url('roaming/save-offer-category') }}" class="form uploadCategoryBanner" enctype="multipart/form-data">
                        @csrf
    ...
    $(function () {
        ...
        $(".category_sortable").sortable({
            ...
            update: function (event, ui) {
                ...
                var save_url = "{{ url('roaming/offer-category-sort') }}";
        ...
        $('.category_edit').on('click', function (e) {
            ...
            $(".cat_update_form").show(200);
            $.ajax({
                url: '{{ url("roaming/get-offer-single-category")}}/' + catId,
                type: 'GET',
                cache: false,
