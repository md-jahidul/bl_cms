    ...
    <div class="card">
        <div class="card-content collapse show">
            <div class="card-body card-dashboard">
                <div class="card-body card-dashboard">
                     <form method="POST" action="{{ route('operator.store') }}" class="form home_news_form" novalidate enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <textarea class="form-control summernote_editor" name="details_en"></textarea>
                                ...
                                <div class="col-md-6 col-xs-12">
                                    ...
                                    <textarea class="form-control summernote_editor" name="details_bn"></textarea>
                                    <small class="text-info">
                                        <strong>Note:</strong> It'll show in offer page pop-up
                                    </small>
                                </div>
