...
@section('action')
<a href="{{ url('roaming/operator/create') }}" class="btn btn-primary round btn-glow px-2"><i class="la la-plus"></i>Add Operator</a>
@endsection
@section('content')
<section>
    <div class="card">
                        ...
                        <form class="form" method="POST"  id="uploadOperator" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <a href="{{ asset('sample-format/roaming-operator-excel.xlsx')}}" class="badge badge-info ml-2">Download Sample Format</a></br>
