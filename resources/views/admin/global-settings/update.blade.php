    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('global-settings.update', $settings) }}" id="settingsForm">
            ...
            <div class="form-group">
                ...
                <input class="form-control datepicker" id="start_time" name="start_time" value="{{ $settings->start_time }}" autocomplete="off">
            </div>

            <div class="form-group">
                <label for="end_time">End Time</label>
                <input class="form-control datepicker" id="end_time" name="end_time" value="{{ $settings->end_time }}" autocomplete="off">
            </div>
