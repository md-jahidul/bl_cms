                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control"
                                           ...
                                           value="{{ $service->subscription_message_en }}"
                                           placeholder="Enter Body Title EN"
                                           required>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control"
                                           ...
                                           placeholder="Enter Body Title BN"
                                           value="{{ $service->subscription_message_bn }}"
                                           required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="is_paid" class="form-control">
                                            <option value="0" {{$service->is_paid=='0' ? 'selected':''}}>Free</option>
                                            <option value="1" {{$service->is_paid=='1' ? 'selected':''}}>Paid</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
