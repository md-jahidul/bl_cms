    ...
    <div class="display-hidden package_price_table_single">
        ...
        <div class="prict_table_new_columns_en">
            <div class="row column_body_wrap">
                <input type="text" class="form-control col-md-4 pull-left" name="column_one_en[]">
                <input type="text" class="form-control col-md-4 pull-left" name="column_two_en[]">
                <input type="text" class="form-control col-md-3 pull-left" name="column_three_en[]">
            </div>
        ...
        <div class="prict_table_new_columns_bn">
            <div class="row column_body_wrap">
                <input type="text" class="form-control col-md-4 pull-left" name="column_one_bn[]">
                <input type="text" class="form-control col-md-4 pull-left" name="column_two_bn[]">
                <input type="text" class="form-control col-md-3 pull-left" name="column_three_bn[]">
