...
@section('content')
<section>
    <form method="POST" action="{{ url('business-internet-save')}}" class="form home_news_form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="volume_data_unit" value="GB" checked>
                                        GB
                                    </label>
                                </div>
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input class="form-check-input" type="radio" name="volume_data_unit" value="MB">
                                        MB
                                    </label>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="offer_type" value="internet" placeholder="Offer Type">
                            </div>
                        ...
                        <div class="col-md-4 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="rate_cutter_offer_rate" placeholder="Rate Cutter Offer Rate">
                            </div>

                            <div class="form-group">
                                <label>Rate Cutter Offer Unit</label>
                                <input type="text" class="form-control" name="rate_cutter_offer_unit" placeholder="Rate Cutter Offer Unit">
                            </div>

                            <div class="form-group">
                                <label>Short Text</label>
                                <input type="text" class="form-control" name="short_text" placeholder="Short Text">
                            </div>
                            <div class="form-group">
                                <label>Tag</label>
                            ...
                            <div class="form-group">
                                <label><input type="checkbox" value="1" name="is_amar_offer"> Is Amar Offer?</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="form-group text-right">
                                <button class="btn btn-info news_submit" type="submit">Save Package</button>
                            </div>
