...
@endsection
@section('action')
    <a href="{{ url('business-types') }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i> Cancel </a>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('network-types.store') }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
                                ...
                                @include('layouts.partials.common_types.image_other_component')
