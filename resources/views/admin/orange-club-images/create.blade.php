        ...
        <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <form novalidate class="form row" action="{{route('orange-club.store')}}"
                            ...
                            <div class="form-group col-12 mb-2 file-repeater">
                                <div class="row mb-1">
                                    {{-- Select User Group --}}
                                    <div class="form-group col-md-12 mb-0 pl-0 section-row"><h5><strong>Create OC Banner</strong></h5></div>
                                    ...
                                    <div class="form-group col-md-6 mb-2">
                                        ...
                                        <textarea rows="3" id="partner_details" name="partner_details" class="form-control" placeholder="Enter Partner Details"></textarea>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
