...
@section('breadcrumb')
    <li class="breadcrumb-item active"> Business Type Add</li>
@endsection
@section('action')
    <a href="{{ url('business-types-items/'.$id) }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i> Cancel </a>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('business-types-datas.store',['id'=>$id]) }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
                                ...
                                @include('layouts.partials.common_types.image_component')
