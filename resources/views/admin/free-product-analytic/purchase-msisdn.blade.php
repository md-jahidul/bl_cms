...
@section('title', 'Free Product Purchase Detail')
@section('card_name', 'Free Product Purchase Detail')

@section('breadcrumb')
    <li class="breadcrumb-item active">
        <a href="{{ route('free-product.purchase.report') }}">Product Purchase List</a>
    </li>
@endsection

@section('action')
    <a href="{{ route('free-product.purchase.report') }}" class="btn btn-primary round btn-glow px-2">
        ...
        <div class="card card-info mt-0" style="box-shadow: 0px 0px">
            <div class="card-content">
                <div class="card-header">
                    <h4>Purchased Product Code: <b>{{ $purchaseProduct->product_code }}</b></h4>
                </div>
            ...
            $("#purchase-msisdn").dataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data, type, row) {
                            let statusData = "";
                            if (row.status === 'buy_success') {
                                statusData = `<span class="badge badge-success">`+row.status+`</span>`;
                            } else {
                                statusData = `<span class="badge badge-danger">`+row.status+`</span>`;
                            }
                            return statusData;
                        }
                    },
