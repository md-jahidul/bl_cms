...
@section('title', 'Free Product Purchase Report')
@section('card_name', 'Free Product Purchase Report')
            ...
            <div class="card-content">
                ...
                <div class="card-body card-dashboard">
                    <table class="table table-striped table-bordered" id="purchase-list" role="grid"
                        ...
                        <tbody>
                            @foreach($purchasedProducts as $data)
                                <tr>
                                    ...
                                    <td>
                                       <a href="{{ route('free-product-purchase-msisdn.list', $data->id) }}"
