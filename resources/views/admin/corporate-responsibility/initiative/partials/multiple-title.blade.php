<div class="form-group col-md-6 {{ $errors->has('title_en') ? ' error' : '' }}">
    ...
    <input type="text" name="multi_item[title_en-1]"  class="form-control" placeholder="Enter company name bangla"
...
<div class="form-group col-md-6 {{ $errors->has('title_bn') ? ' error' : '' }}">
    ...
    <input type="text" name="multi_item[title_bn-1]"  class="form-control" placeholder="Enter company name bangla"
