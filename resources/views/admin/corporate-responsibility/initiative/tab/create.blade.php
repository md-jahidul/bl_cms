...
@section('title_en', 'Initiate Tap Create')
@section('card_name', 'Initiate Tap Create')
@section('breadcrumb')
    <li class="breadcrumb-item active"> Initiate Tap Create</li>
@endsection
@section('action')
    <a href="{{ route('initiative-tab.index') }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i> Cancel </a>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form id="product_form" role="form" action="{{ route('initiative-tab.store') }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
