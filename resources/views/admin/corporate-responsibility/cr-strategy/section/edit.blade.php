        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('cr-strategy-section.update', $section->id) }}" method="POST" novalidate enctype="multipart/form-data">
                            @method('PUT')
                            <div class="row">
                                <div class="form-group col-md-6 {{ $errors->has('title_en') ? ' error' : '' }}">
                                    <label for="title_en" class="required">Title English</label>
                                    <input type="text" name="title_en"  class="form-control" placeholder="Enter title in English"
                                           value="{{ $section->title_en }}" required data-validation-required-message="Enter title in English">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('title_bn') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="title_bn"  class="form-control" placeholder="Enter title in Bangla"
                                           value="{{ $section->title_bn }}" required data-validation-required-message="Enter title in Bangla">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('section_type') ? ' error' : '' }}">
                                    ...
                                    <select class="form-control" name="section_type"
                                        ...
                                        <option data-alias="slider_section" value="slider_section" {{ $section->section_type == "slider_section" ? 'selected' : '' }}>Slider Section</option>
                                        <option data-alias="card_section" value="card_section" {{ $section->section_type == "card_section" ? 'selected' : '' }}>Card Section</option>
                                    </select>
                                    <div class="help-block"></div>
