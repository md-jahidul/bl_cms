...
@section('title_en', 'Case Study & Report Section Create')
@section('card_name', 'Case Study & Report Section Create')
@section('breadcrumb')
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form id="product_form" role="form" action="{{ route('case-study-section.store') }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('section_type') ? ' error' : '' }}">
                                    ...
                                    <select class="form-control" name="section_type"
                                        ...
                                        <option data-alias="left_image_right_text" value="left_image_right_text">Left Image Right Text</option>
                                        <option data-alias="top_image_button_text" value="top_image_button_text">Top Image Button Text</option>
                                    </select>
                                    <div class="help-block"></div>
