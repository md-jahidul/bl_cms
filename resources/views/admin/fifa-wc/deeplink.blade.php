...
@section('title', 'Fifa Deeplink')
@section('card_name', 'Fifa Deeplink')
@section('breadcrumb')
    <li class="breadcrumb-item active">Fifa Content</li>
@endsection
...
@section('content')
    ...
    <section>
        <form
            action="  {{route('fifa-deeplink.store')}}  "
                ...
                <div class="row px-1 pt-1">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="detail_id" class="required">Section Name :</label>
                            <input
                                type="text" name="detail_id" class="form-control @error('detail_id') is-invalid @enderror"
                                id="detail_id" placeholder="Enter fifa valid section name" required>
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <table class="table table-striped table-bordered"
                        ...
                        <tbody>
                        @foreach ($fifaDeeplinkItem as $key => $item)
                            <tr>
                                <td> {{ ++$key }}</td>
...
@push('page-js')
    ...
    <script>
        let deep_link_create_url = "{{ url('fifa-deeplink/create?') }}category=";
    </script>
    <script>
        $(function () {
            $('.delete').click(function () {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ url('fifa-deeplink/destroy') }}/"+id,
                            methods: "get",
                            success: function (res) {
                                ...
                                function redirect() {
                                    window.location.href = "{{ url('fifa-deeplink') }}"
                                }
                            }
                        })
                    }
