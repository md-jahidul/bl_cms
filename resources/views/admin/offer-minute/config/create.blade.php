...
@section('title', 'Minutes Pack Filter Configuration')
@section('card_name', "Minutes Pack Filter")
@section('breadcrumb')
            ...
            <div class="card-content">
                <div id="settings_panel" role="tablist" aria-multiselectable="true">
                    <div class="card collapse-icon accordion-icon-rotate">
                        ...
                        @include('admin.offer-minute.config._partials.price_config_form')
                        <!---------------  Internet Config ------------------------------------>

                        @include('admin.offer-minute.config._partials.minute_config_form')

                        <!---------------  Validation Config ------------------------------------>
                       @include('admin.offer-minute.config._partials.validity_config_form')

                    <!---------------  Sorting Config ------------------------------------>
                        @include('admin.offer-minute.config._partials.sorting_config_form')
