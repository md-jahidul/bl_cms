...
@section('title', 'Create Content Filter')
@section('card_name', 'Create Content Filter')
@section('breadcrumb')
    <li class="breadcrumb-item active">Create Content Filter</li>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form"
                              action="{{ route('content-filter.store') }}"
                              method="POST"
                              class="form"
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="content_for" class="form-control">
                                            ...
                                            @foreach (config('content-filter.component_for') as $key => $val)
                                                <option
                                                    value="{{ $key }}" {{ old("content_for") == $key ? 'selected' : '' }}>  {{$val}}
                                                </option>
                                            @endforeach
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    @if($errors->has('content_type'))
                                        <p class="text-left">
                                            <small class="danger text-muted">{{ $errors->first('content_type') }}</small>
                                        </p>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
