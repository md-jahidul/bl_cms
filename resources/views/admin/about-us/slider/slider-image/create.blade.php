...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active"> <a href="{{ route('about_image_list', [$sliderId, $type]) }}"> Slider Image List</a></li>
    <li class="breadcrumb-item active"> Slider Image Create</li>
@endsection
@section('action')
    <a href="{{ route('about_image_list', [$sliderId, $type]) }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i> Cancel </a>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('about_image_store', [$sliderId, $type]) }}" method="POST" novalidate enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-1 {{ $errors->has('image_url') ? ' error' : '' }}">
                                ...
                                <div class="form-group col-md-6 mb-1 {{ $errors->has('mobile_view_img') ? ' error' : '' }}">
