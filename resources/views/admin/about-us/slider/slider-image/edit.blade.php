...
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ url('about-slider') }}"> About-Slider</a></li>
    <li class="breadcrumb-item active"> <a href="{{ route('about_image_list', [$sliderImage->slider_id, $type]) }}"> Slider Image List</a></li>
    <li class="breadcrumb-item active"> Slider Image Edit</li>
@endsection
@section('action')
    <a href="{{ route('about_image_list', [$sliderImage->slider_id, $type]) }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i> Cancel </a>
@endsection
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route("about_image_update", [ $sliderImage->slider_id, $type, $sliderImage->id ]) }}" method="POST" novalidate enctype="multipart/form-data">
                            @csrf
                            {{method_field('POST')}}
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 mb-1 {{ $errors->has('image_name') ? ' error' : '' }}">
                                ...
                                <div class="form-group col-md-6 mb-1 {{ $errors->has('image_name_bn') ? ' error' : '' }}">
                                ...
                                <div class="form-group col-md-6 mb-0 {{ $errors->has('alt_text') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="alt_text"  class="form-control" placeholder="Enter alt text"
                                           ...
                                           value="{{ old("title") ? old("title") : $sliderImage->alt_text }}">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6 mb-0 {{ $errors->has('alt_text_bn') ? ' error' : '' }}">
                                    <label>Alt Text BN</label>
                                    <input type="text" name="alt_text_bn"  class="form-control" placeholder="Enter alt text bn"
                                           value="{{ old("title") ? old("title") :  $sliderImage->alt_text_bn }}">
                                </div>
