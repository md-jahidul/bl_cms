...
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ url('tag-category') }}">About Career</a></li>
    <li class="breadcrumb-item active"><a href="{{ url('tag-category') }}">About Career Item List</a></li>
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('career-item.update', [$careerId, $aboutCareerItem->id]) }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
                                <div class="form-group col-md-6 {{ $errors->has('title_en') ? ' error' : '' }}">
                                    <label for="title_en" class="required">Title (English)</label>
                                    <input type="text" name="title_en"  class="form-control" placeholder="Enter tag name"
                                           value="{{ $aboutCareerItem->title_en }}" required data-validation-required-message="Enter title in English">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('title_bn') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="title_bn"  class="form-control" placeholder="Enter tag name"
                                           value="{{ $aboutCareerItem->title_bn }}" required data-validation-required-message="Enter title in Bangla">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('description_en') ? ' error' : '' }}">
                                    ...
                                    <textarea type="text" name="description_en"  class="form-control" placeholder="Enter description in English"
                                              required data-validation-required-message="Enter description in english">{{ $aboutCareerItem->description_en }}</textarea>
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('description_bn') ? ' error' : '' }}">
                                    ...
                                    <textarea type="text" name="description_bn"  class="form-control" placeholder="Enter description in Bangla"
                                              required data-validation-required-message="Enter description in bangla">{{ $aboutCareerItem->description_bn }}</textarea>
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" name="image" class="dropify"
                                               data-default-file="{{ config('filesystems.file_base_url'). $aboutCareerItem->image }}" data-height="80">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-3 {{ $errors->has('image_name') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="image_name"  class="form-control" placeholder="Enter image name en"
                                           value="{{ old('image_name') ? old('image_name') : $aboutCareerItem->image_name }}">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-3 {{ $errors->has('image_name_bn') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="image_name_bn"  class="form-control" placeholder="Enter image name bn"
                                           value="{{ old('image_name_bn') ? old('image_name_bn') : $aboutCareerItem->image_name_bn }}">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="alt_text"  class="form-control" placeholder="Enter alt text en"
                                           value="{{ old('alt_text') ? old('alt_text') : $aboutCareerItem->alt_text }}">
                                </div>

                                <div class="form-group col-md-4">
                                    <label>Alt Text BN</label>
                                    <input type="text" name="alt_text_bn"  class="form-control"  placeholder="Enter alt text bn"
                                        value="{{ old('alt_text_bn') ? old('alt_text_bn') : $aboutCareerItem->alt_text_bn }}">
                                </div>

                                <div class="form-group col-md-4">
                                    <label for="alt_text">Alt Link</label>
                                    <input type="text" name="alt_links" placeholder="Enter alt link" class="form-control" value="{{ $aboutCareerItem->alt_links }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group {{ $errors->has('status') ? ' error' : '' }}">
                                        ...
                                        <input type="radio" name="is_active" value="1" id="input-radio-15" {{ $aboutCareerItem->is_active == 1 ? 'checked' : '' }}>
                                        <label for="input-radio-15" class="mr-1">Active</label>

                                        <input type="radio" name="is_active" value="0" id="input-radio-16" {{ $aboutCareerItem->is_active == 0 ? 'checked' : '' }}>
