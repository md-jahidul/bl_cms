...
@section('title', 'Add Special Type')
@section('card_name',"Add Special Type" )
@section('breadcrumb')
    <li class="breadcrumb-item active">Add Special Type</li>
@endsection
@section('action')
        ...
        <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <form novalidate class="form row" action="{{route('product-special-types.store')}}"
