...
@section('breadcrumb')
    <li class="breadcrumb-item active">
        <a href="{{ route('al-cash-back-campaign.index') }}">Campaign List</a>
    </li>
    <li class="breadcrumb-item active">Create Campaign</li>
@endsection
@section('action')
    <a href="{{ route('al-cash-back-campaign.index') }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i>
        Cancel
    </a>
@endsection
                ...
                <div class="card-body card-dashboard">
                    ...
                    <div class="card-body card-dashboard">
                        <form id="feed-form" novalidate class="form row"
                              action="{{ (isset($campaign)) ? route('al-cash-back-campaign.update', $campaign->id) : route('al-cash-back-campaign.store')}}"
                                ...
                                <div class="row report-repeater" id="productSection" data-repeater-list="product-group">
                                    @if(isset($campaign))
                                        @foreach($campaign->cashBackProducts as $product)
                                            @include('admin.al-campaign.cash-back.partials.product-element', ['product' => $product])
                                        @endforeach
                                    @else
                                        @include('admin.al-campaign.cash-back.partials.product-element')
                                    @endif
                                </div>
                                <div class="row">
