                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('year_en') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="year_en"  class="form-control" placeholder="Enter year in English"
                                           value="{{ old("year_en") ? old("year_en") : '' }}" required data-validation-required-message="Enter year in English">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('year_bn') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="year_bn"  class="form-control" placeholder="Enter year in Bangla"
                                           value="{{ old("year_bn") ? old("year_bn") : '' }}" required data-validation-required-message="Enter year in Bangla">
                                    <div class="help-block"></div>
