            ...
            <form id="product_details_form" role="form" action="{{ route('app_service.details.store', [$tab_type, $product_id ]) }}" method="POST" novalidate enctype="multipart/form-data">
              ...
              <div class="modal-body">
                <div class="row">
                		...
                		{{ Form::hidden('component[component_type]', 'text_with_image_right' ) }}
							...
							<div class="form-group col-md-6 {{ $errors->has('title_en') ? ' error' : '' }}">
							    ...
							    <input type="text" name="component[title_en]"  class="form-control section_name" placeholder="Enter title"
							 ...
							 <div class="form-group col-md-6 {{ $errors->has('title_bn') ? ' error' : '' }}">
							     ...
							     <input type="text" name="component[title_bn]"  class="form-control section_name" placeholder="Enter title"
							...
							<div class="form-group col-md-5 {{ $errors->has('image_url') ? ' error' : '' }}">
							    ...
							    <div class="custom-file">
							        <input type="file" name="component[image_url]" class="custom-file-input" id="image">
							...
							<div class="form-group col-md-6 {{ $errors->has('alt_text') ? ' error' : '' }}">
							    ...
							    <input type="text" name="component[alt_text]"  class="form-control"
