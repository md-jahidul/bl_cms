                                ...
                                <div class="card accordion collapse-icon accordion-icon-rotate" data-index="1" data-position="1">
                                  ...
                                  <div id="collapse_1" class="collapse show1 border-info" data-parent="#accordion">
                                    <div class="card-body">
                                       ...
                                       <div class="row">
                                          <div class="form-group col-md-6 {{ $errors->has('title_en') ? ' error' : '' }}">
                                             <label for="title_en" class="required1">Content Title (English)</label>
                                             <input type="text" name="component[0][multi_item][content_title_en-1]"  class="form-control"
                                                    value="{{ !empty($ecarrer_item->title_en) ? $ecarrer_item->title_en : '' }}" >
                                             <div class="help-block"></div>
                                             @if ($errors->has('title_en'))
                                                 <div class="help-block">  {{ $errors->first('content_title_en') }}</div>
                                             @endif
                                          </div>

                                          <div class="form-group col-md-6 {{ $errors->has('title_bn') ? ' error' : '' }}">
                                             <label for="title_bn" class="required1">Content Title (Bangla)</label>
                                             <input type="text" name="component[0][multi_item][content_title_bn-1]"  class="form-control"
                                                    value="{{ !empty($ecarrer_item->title_bn) ? $ecarrer_item->title_bn : '' }}" >
                                             <div class="help-block"></div>
                                             @if ($errors->has('title_bn'))
                                                 <div class="help-block">  {{ $errors->first('content_title_bn') }}</div>
                                             @endif
                                          </div>
