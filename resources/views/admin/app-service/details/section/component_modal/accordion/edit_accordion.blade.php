<!-- Modal -->
<div class="modal fade" id="edit_accordion_section" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-number_of_compoent="1">
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<div class="add_button_wrap float-right">
										  <a href="#" class="btn btn-info  btn-glow px-1 edit_multi_image_item_add">+ Add Item</a>
										</div>
									</div>
								</div>
								<div class="row">
										...
										{{ Form::hidden('component[0][component_type]', 'accordion_section' ) }}
...
<script type="text/javascript">
	$(document).ready(function () {
	   ...
	   $('.edit_multi_image_item_add').on('click', function(e){
	   	...
	   	$parentSelectorEdit = $('#edit_accordion_section');
	     ...
	     $parentSelector.on('hidden.bs.modal', function(){
	         // $('#accordion_section').find('.multi_attr_update_hide').show();
	         location.reload();
	         return false;
	     });
	   ...
	   var $singleModalID = $('#single_item_edit_accordion_section');
	   var $editedModalID = $('#edit_accordion_section');
