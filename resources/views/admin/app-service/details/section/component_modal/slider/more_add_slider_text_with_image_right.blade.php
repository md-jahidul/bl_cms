								...
								<div class="row">
									<div class="col-sm-12">
										<div class="add_button_wrap float-right">
										  <a href="#" class="btn btn-info  btn-glow px-1 add_moreslider_item"><i class="la la-plus"></i> Add slide</a>
										</div>
									</div>
								</div>
                                            ...
                                            <div class="row single_slider_content" style="margin-bottom: 30px;padding-bottom: 30px;border-bottom: 1px solid #d1d5ea;">
                                                ...
                                                <div class="form-group col-md-4 {{ $errors->has('image_url') ? ' error' : '' }}">
                                                    ...
                                                    <div class="custom-file">
                                                        <input type="file" name="component[0][multi_item][image_url-1]" class="dropify-multiple">
                                                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('.add_moreslider_item').on('click', function(event){
                ...
                html += '<div class="row single_slider_content">' +
