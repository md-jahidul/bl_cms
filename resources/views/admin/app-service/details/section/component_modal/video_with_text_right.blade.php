...
<div class="form-group col-md-6 ">
    ...
    >{{ isset($component->description_en) ? $component->description_en : '' }}</textarea>
    <div class="help-block"></div>
</div>
...
<div class="form-group col-md-6 ">
    ...
    >{{ isset($component->description_bn) ? $component->description_bn : '' }}</textarea>
    <div class="help-block"></div>
</div>


@php
    $videoType = isset($component->other_attributes) ? json_decode($component->other_attributes, true)['video_type'] : '';
@endphp

<div class="form-group col-md-6  {{ $errors->has('video_type') ? ' error' : '' }}">
    ...
    <select id="select_video_type" class="form-control" name="component[0][other_attr][video_type]"
        ...
        <option value="uploaded_video" {{ isset($videoType) && ($videoType == "uploaded_video") ? 'selected' : '' }}>Upload video</option>
        <option value="youtube_video" {{ isset($videoType) && ($videoType == "youtube_video") ? 'selected' : ''  }}>Youtube video link</option>
    </select>
    <div class="help-block"></div>
...
<div class="uploaded_video form-group col-md-6 {{ $errors->has('video_url') ? ' error' : '' }} {{ $videoType == "uploaded_video" ? "" : 'd-none' }}">
...
@if(isset($component->video))
    <div class="uploaded_video form-group col-md-6 {{ $errors->has('video_url') ? ' error' : '' }} {{ $videoType == "uploaded_video" ? "" : 'd-none' }}">
        <label for="alt_text" class="">Uploaded Video</label>
        <video width="400" controls>
            <source src="{{ config('filesystems.file_base_url') . $component->video }}" type="video/mp4">
...
<div class="youtube_video form-group col-md-6 {{ $errors->has('video_url') ? ' error' : '' }} {{ $videoType == "youtube_video" ? "" : 'd-none' }}">
    ...
    <input type="text" name="component[0][video_url]"  class="form-control"
           value="{{ isset($component->video) ? $component->video : '' }}">
    <div class="help-block"></div>
...
{{--        </div>--}}
{{--    @else--}}
{{--        <div class="youtube_video form-group col-md-6 {{ $errors->has('video_url') ? ' error' : '' }}">--}}
{{--            <label for="video_url" class="required1">Youtube video link</label>--}}
{{--            <input type="text" name="component[0][video_url]"  class="form-control"--}}
  ...
  $(document).ready(function () {
     ...
     $('#select_video_type').on('change', function(){
      ...
      if( selected == 'youtube_video' ){
        ...
        $(this).closest('form').find('div.youtube_video').removeClass('d-none');
        $(this).closest('form').find('div.uploaded_video').addClass('d-none');

      }
      else if(selected == 'uploaded_video'){
        $(this).closest('form').find('div.uploaded_video').removeClass('d-none');
        $(this).closest('form').find('div.youtube_video').addClass('d-none');
      }
