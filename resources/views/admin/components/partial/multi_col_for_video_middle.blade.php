{{ Form::hidden('component_type', 'multi_col_for_video_middle' ) }}

<div class="col-sm-12">
    <div class="add_button_wrap float-right">
      <a href="#" class="btn btn-info  btn-glow px-1 add_more_multi_col_video_middle_item">+ Add Column</a>
    </div>
</div>
    ...
    <div id="multi_col_video_content_section" class="multi_col_video_content_section" data-count="1">
        ...
        @if (isset($component->multiple_attributes))
            ...
            @foreach ( $component->multiple_attributes as $key => $single_attribute )
                <h4>Column: {{ $key +1 }}</h4>
                <hr class="hr">
                <div class="row single_multi_col_video_middle_content">
...
<script type="text/javascript">
	$(document).ready(function () {
	   ...
	   // Add multiple item
	   $('.add_more_multi_col_video_middle_item').on('click', function(event){
            
            event.preventDefault();


	   	$parentSelector = $('#multi_col_for_video_middle');
	    ...
	    html += '<h4>Column: '+i+'</h4> <hr class="hr"><div class="row single_multi_col_video_middle_content"><input type="hidden" name="multi_item[id-'+i+']" value="'+i+'"><input type="hidden" name="multi_item[display_order-'+i+']" value="'+i+'">'+
	   ...
	   $(document).on('click', '.multi_item_remove', function(e){
	     ...
	     $(this).parents('.row.single_multi_col_video_middle_content').remove();
