                                    ...
                                    <div class="controls">
                                        <select name="category_id" id="category_id" required
                                            ...
                                            @foreach ($categories as $category)
                                                <option
                                                    @if(old("category_id")) {{ (old("category_id") == $category->id ? "selected":"") }}  @elseif($category->id == $notification->category_id) selected
                                                    @endif value="{{$category->id}}" {{ (old("category_id") == $category->id ? "selected":"") }}>{{$category->name}}</option>
                                            @endforeach
                                        </select>
                                        <div class="help-block"></div>
                                        <small
                                            class="text-danger"> @error('category_id') {{ $message }} @enderror </small>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="device_type" id="device_type" class="form-control" required>
                                            ...
                                            <option value="all" @if($notification->device_type=='all') selected @endif>
                                                All
                                            </option>
                                            <option value="ios" @if($notification->device_type=='ios') selected @endif>
                                                IOS
                                            </option>
                                            <option value="android"
                                                    @if($notification->device_type=='android') selected @endif>Android
                                            </option>
                                        </select>
                                        <div class="help-block"></div>
                                        <small
                                            class="text-danger"> @error('device_type') {{ $message }} @enderror </small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select name="customer_type" id="customer_type" required class="form-control">
                                            ...
                                            <option value="all"
                                                    @if($notification->customer_type=='all') selected @endif>All
                                            </option>
                                            <option value="prepaid"
                                                    @if($notification->customer_type=='prepaid') selected @endif>Prepaid
                                            </option>
                                            <option value="postpaid"
                                                    @if($notification->customer_type=='postpaid') selected @endif>
                                                Postpaid
                                            </option>
                                        </select>
                                        <div class="help-block"></div>
                                        <small
                                            class="text-danger"> @error('customer_type') {{ $message }} @enderror </small>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="Enter body description....." id="body" name="body"
                                        rows="10">@if(old('body')){{old('body')}} @else {{$notification->body}}@endif</textarea>
                                    <div class="help-block"></div>
                            ...
                            <div class="col-md-6">
                                ...
                                <label class="small">
                                    ...
                                    Edit will update the active schedule title and body accordingly
                                </label><br>
                                @endif
                                ...
                                <a href="{{route('notification.index')}}" class="btn btn-warning round px-2">
