...
@section('title', 'SMS Pack Filter Configuration')
@section('card_name', "SMS Pack Filter")
@section('breadcrumb')
            ...
            <div class="card-content">
                <div id="settings_panel" role="tablist" aria-multiselectable="true">
                    <div class="card collapse-icon accordion-icon-rotate">
                        ...
                        @include('admin.offer-sms.config._partials.price_config_form')
                        <!---------------  Internet Config ------------------------------------>

                        @include('admin.offer-sms.config._partials.sms_config_form')

                        <!---------------  Validation Config ------------------------------------>
                       @include('admin.offer-sms.config._partials.validity_config_form')

                    <!---------------  Sorting Config ------------------------------------>
                        @include('admin.offer-sms.config._partials.sorting_config_form')
