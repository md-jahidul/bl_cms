...
@section('title_en', 'CSR Category Edit')
@section('card_name', 'CSR Category')
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ url('csr-post') }}">CSR Category List</a></li>
    <li class="breadcrumb-item active"> CSR Category Edit</li>
@endsection
@section('action')
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('csr-categories.update', $category->id) }}" method="POST" novalidate enctype="multipart/form-data">
                            @method('PUT')
