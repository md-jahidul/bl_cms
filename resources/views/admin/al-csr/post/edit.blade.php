...
@section('title_en', 'CSR Post Edit')
@section('card_name', 'CSR Post')
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ url('csr-post') }}">CSR Post List</a></li>
    <li class="breadcrumb-item active"> CSR Post Edit</li>
@endsection
@section('action')
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('csr-post.update', $blogPost->id) }}" method="POST" novalidate enctype="multipart/form-data">
                            @method('PUT')
