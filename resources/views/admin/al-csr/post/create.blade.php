...
@section('title_en', 'CSR Post Create')
@section('card_name', 'CSR')
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ url('csr-post') }}">CSR Post List</a></li>
    <li class="breadcrumb-item active"> CSR Post Create</li>
@endsection
@section('action')
        ...
        <div class="card">
            <div class="card-content">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form id="product_form" role="form" action="{{ route('csr-post.store') }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('media_news_category_id') ? ' error' : '' }}">
                                    <label for="media_news_category_id" class="required">Select CSR Category</label>
                                    <select class="form-control" name="media_news_category_id" aria-invalid="false" required data-validation-required-message="Enter Category">
                                        <option value="">Select a CSR category</option>
