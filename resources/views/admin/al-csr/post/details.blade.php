...
@section('card_name', "CSR Content")
@section('breadcrumb')
    <li class="breadcrumb-item active"> <a href="{{ url('csr-post') }}"> CSR List</a></li>
    <li class="breadcrumb-item active">CSR Details</li>
@endsection

@section('action')
    <a href="{{ route('csr-component.create', ['section_id' => request()->blog_id])}}" class="btn btn-primary btn-glow px-2"><i class="la la-list"></i> Add Component </a>
@endsection
@section('content')
    ...
    @php
        ...
        $action = [
            'edit' => 'csr-component/edit',
            'destroy' => 'csr-component/destroy',
            'componentSort' => 'csr-component-sort',
...
{{--                    <hr>--}}
{{--                    <div class="card-body card-dashboard">--}}
{{--                        <form role="form" action="{{ route('csr.adtech.store') }}"--}}
