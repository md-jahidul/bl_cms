...
@section('title_en', 'CSR Landing Page Component')
@section('card_name', 'CSR Landing Page Component')
@section('breadcrumb')
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('csr-landing-page-component.update', $component->id) }}" method="POST" novalidate enctype="multipart/form-data">
                            @method('PUT')
                            <div class="row">
