...
@section('title_en', 'CSR Landing Page')
@section('card_name', 'CSR Landing Page')
@section('breadcrumb')
    <li class="breadcrumb-item active"><a href="{{ url('csr-landing-page-component') }}">Component List</a></li>
    <li class="breadcrumb-item active"> Component Create</li>
@endsection
@section('action')
    <a href="{{ url('csr-landing-page-component') }}" class="btn btn-warning  btn-glow px-2"><i class="la la-list"></i> Cancel </a>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form" action="{{ route('csr-landing-page-component.store') }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
...
{{--                                        <option value="">---Select Type---</option>--}}
                                        <option data-alias="latest_news" value="latest_news" selected>Latest News</option>
