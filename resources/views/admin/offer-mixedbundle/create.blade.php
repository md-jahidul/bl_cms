                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" min="0" value="" id="internet" class="form-control @error('internet') is-invalid @enderror" placeholder="Enter volume...." name="internet">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" min="0" value="" id="minutes" class="form-control @error('minutes') is-invalid @enderror" placeholder="Enter volume...." name="minutes">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" min="0" value="" id="sms" class="form-control @error('sms') is-invalid @enderror" placeholder="Enter volume...." name="sms">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" min="0" value="" id="price" class="form-control @error('price') is-invalid @enderror" placeholder="Price.." name="price">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" min="0" value="" id="points" class="form-control @error('points') is-invalid @enderror" placeholder="Points.." name="points">
                                        @error('points')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" value="" id="offer_code" class="form-control @error('offer_code') is-invalid @enderror" placeholder="Offer code.." name="offer_code">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input required type="text" value="" id="tag" class="form-control @error('tag') is-invalid @enderror" placeholder="Offer code.." name="tag">
                                        @error('tag')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input required type="number" min="0" value="" id="validity" class="form-control @error('validity') is-invalid @enderror" placeholder="" name="validity">
