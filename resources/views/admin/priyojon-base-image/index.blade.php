...
@section('title', 'Base Images')
@section('card_name', 'Base Image')
@section('breadcrumb')
    <li class="breadcrumb-item active">Image List</li>
@endsection
@section('action')
    <a href="{{route('priyojon-base-image.create')}}" class="btn btn-primary  round btn-glow px-2"><i class="la la-plus"></i>
        Create Slider
    </a>
@endsection
@section('content')
