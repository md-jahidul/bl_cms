...
@section('card_name', 'Edit Component')
@section('breadcrumb')
    <li class="breadcrumb-item active">Edit {{ $routeObj['componentName'] }} Component</li>
@endsection
@section('action')
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('title_en') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="title_en"  class="form-control" placeholder="Enter english label"
                                           required data-validation-required-message="Enter footer menu english label" value="{{ $componentData['title_en'] }}">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('title_bn') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="title_bn"  class="form-control" placeholder="Enter label in Bangla"
                                           required data-validation-required-message="Enter label in Bangla" value="{{ $componentData['title_bn'] }}">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('android_version_code') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="android_version_code"  class="form-control" placeholder="Enter Version Code"
                                           required data-validation-required-message="Enter Version Code" value="{{ $componentData['android_version_code'] }}">
                                    <div class="help-block"></div>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('ios_version_code') ? ' error' : '' }}">
                                    ...
                                    <input type="text" name="ios_version_code"  class="form-control" placeholder="Enter Version Code"
                                           required data-validation-required-message="Enter Version Code" value="{{ $componentData['ios_version_code'] }}">
                                    <div class="help-block"></div>
                                    <span class="text-info"><strong><i class="la la-info-circle"></i></strong> Version code should be Hyphen-separated value. Example: 10-99</span>
                                    <div class="help-block"></div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="is_eligible" value="1" id="active" {{ $componentData['is_eligible'] == 1 ? 'checked' : ""}}>
                                        <label for="active" class="mr-1">Yes</label>

                                        <input type="radio" name="is_eligible" value="0" id="inactive" {{ $componentData['is_eligible'] == 0 ? 'checked' : ""}}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="is_api_call_enable" value="1" id="can_enable_yes" {{ $componentData['is_api_call_enable'] == 1 ? 'checked' : ""}}>
                                        <label for="can_enable_yes" class="mr-1">Enable</label>

                                        <input type="radio" name="is_api_call_enable" value="0" id="can_disable_no" {{ $componentData['is_api_call_enable'] == 0 ? 'checked' : ""}}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="radio" name="is_title_show" value="1" id="is_title_show_active" {{ $componentData['is_title_show'] == 1 ? 'checked' : ""}}>
                                        <label for="active" class="mr-1">Yes</label>
                                        <input type="radio" name="is_title_show" value="0" id="is_title_show_inactive" {{ $componentData['is_title_show'] == 0 ? 'checked' : ""}}>
                                        <label for="inactive">No</label>
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="cta_name_en" id="cta_name_en" class="form-control"
                                           placeholder="Enter Cta Name En." value="{{ $componentData['cta_name_en'] }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="cta_name_en">Cta Name BN</label>
                                    <input type="text" name="cta_name_bn" id="cta_name_bn" class="form-control"
                                           placeholder="Enter Cta Name Bn." value="{{ $componentData['cta_name_bn'] }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="deeplink">Deeplink</label>
                                    <input type="text" name="deeplink" id="deeplink" class="form-control"
                                           placeholder="Enter Deeplink URL." value="{{ $componentData['deeplink'] }}">
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="icon">icon</label>
                                    <input type="text" name="icon" id="icon" class="form-control"
                                           placeholder="Enter Icon URL." value="{{ $componentData['icon'] }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select multiple class="w-100 select2 childes" name="child_ids[]" style="width: 100%">
                                        ...
                                        @foreach ($candidateChildes as $key => $child)
                                            @if ($componentData['id'] != $child['id'])
                                                <option value="{{ $child['id'] }}" {{ in_array($child['id'], $componentData['child_ids']) ? 'selected' : '' }}>  {{$child['title_en']}}  </option>
                                            @endif
