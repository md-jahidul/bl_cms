                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group {{ $errors->has('description') ? ' error' : '' }}">
                                        ...
                                        <textarea 
                                        required
                                        data-validation-required-message="Description is required"  class="form-control" name="description" placeholder="Enter description..." id="description" rows="2">{{ old("description") ? old("description") : $contextualCard->description }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="first_action" class="browser-default custom-select">
                                            ...
                                            @foreach ($actionList as $key => $value)
                                                <option value="{{ $key }}" {{ ( $key == $contextualCard->first_action) ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <select name="second_action" class="browser-default custom-select">
                                            ...
                                            @foreach ($actionList as $key => $value)
                                                <option value="{{ $key }}" {{ ( $key == $contextualCard->second_action) ? 'selected' : '' }}>
                                                    {{ $value }}
                                                </option>
                                            @endforeach
                                        </select>
