    ...
    <div class="card">
        <div class="card-content collapse show">
            <div class="card-body card-dashboard">
                <div class="card-body card-dashboard">
                    <form role="form"
                          action="{{ route('utility-bill.update', $billUtility->id) }}"
                          method="POST"
                          class="form"
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label for="title_en" class="required">Bill Category Name En</label>
                                <input class="form-control"
                                       name="title_en"
                                       id="title_en"
                                       value="{{$billUtility->title_en}}"
                            ...
                            <div class="form-group col-md-6">
                                <label for="title_bn" class="required">Bill Utility Name Bn</label>
                                <input class="form-control"
                                       name="title_bn"
                                       id="title_bn"
                                       value="{{$billUtility->title_bn}}"
                            ...
                            <div id="image-input" class="form-group col-md-6 mb-2">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="icon" name="icon" class="dropify_image"
                                           data-default-file="{{  asset($billUtility->icon) }}"
