...
@section('breadcrumb')
    <li class="breadcrumb-item active">Welcome Banner-list</li>
@endsection
@section('action')
    ...
    <section>
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-10">
                        <h1 class="card-title pl-1">Welcome Banner List</h1>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-bordered alt-pagination no-footer dataTable"
                        ...
                        @foreach ($welcome_banners as $key=>$item)
                            <tr>
                                ...
                                <td width='10%'><img style="height:50px;width:100px" src="{{asset($item->banner_img)}}" alt="" srcset=""></td>
                                <td width='30%'>
                                    <div class="row justify-content-md-center no-gutters">
                                        <div class="col-md-3">
                                            <a role="button" href="{{route('welcome-banner.edit',$item->id)}}" class="btn btn-outline-success">
                                                <i class="la la-pencil"></i>
                                            </a>
                                        </div>
                                        <div class="col-md-3">
                                            <button data-id="{{$item->id}}" class="btn btn-outline-danger delete" onclick=""><i class="la la-trash"></i></button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
