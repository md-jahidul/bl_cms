                        ...
                        <div class="card-content">
                            <div class="media align-items-stretch">
                                ...
                                <div class="media-body p-2">
                                    ...
                                    <h6 class="warning">valid
                                        Till {{ \Carbon\Carbon::parse($summary->data->balance->expires_in, 'UTC')->setTimezone("Asia/Dhaka")->format('d M, Y') }} </h6>
                                </div>
                ...
                <div class="col-md-6">
                    <div class="card" style="margin-top: 100px;">
                        <div class="card-content">
                            <div class="media align-items-stretch">
                                <div class="p-2 media-middle">
                                    <h1 class="success">{{ number_format($summary->data->balance-> total_outstanding) }}
                                        TK</h1>
                                </div>
                                <div class="media-body p-2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="progress mt-1 mb-0"
                                                 style="height: 12px;background-color:#b0bec5; ">
                                                <div class="progress-bar bg-warning"
                                                    ...
                                                    <b>{{ round(($summary->data->balance-> total_outstanding/$summary->data->balance->credit_limit)*100) }}
                                                        %</b>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="media d-flex">
                                    <div class="media-body text-left">
                                        <h3 class="info"
                                            id="summary_sms">{{ number_format($summary->data->sms->total) }}</h3>
                                        <span>SMS</span>
                                    </div>
                                    <div class="align-self-center">
