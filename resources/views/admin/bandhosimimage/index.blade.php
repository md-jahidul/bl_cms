        ...
        <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    @if(isset($image))
                        <form action="{{ route('mybl.settings.bandho.sim.image.update',$image->id) }}" method="POST"
                              enctype="multipart/form-data">
                            @else
                                <form action="{{ route('mybl.settings.bandho.sim.image.store')}}" class="form"
            ...
            <div class="card-body card-dashboard">
                <div class="col-md-12">
                    @if(isset($image->image_url))
                        {{--            <img src="https://webcms-test.banglalink.net/storage/bandhosimimage/q1ZykUONH9zzKjah5JtUAki59H3y9wbpTICOX4fQ.png" height="100" width="200">--}}
                        <img src="{{ asset($image->image_url) }}" alt="Slider Image" height="100" width="200"/>
                    @endif
                </div>
            </div>
        </div>
