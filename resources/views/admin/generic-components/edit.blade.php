...
@section('title', 'Edit Generic Component')
@section('card_name', 'Edit Generic Component')
@section('breadcrumb')
    <li class="breadcrumb-item active">Edit Generic Component</li>
@endsection
@section('content')
    <section>
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form role="form"
                              action="{{ route('generic-components.update', $component->id) }}"
                              method="POST"
                              class="form"
