...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('programs/ennovatorbatches') }}">Section List</a></li>
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <div class="card-body card-dashboard">
                        <form id="ennovatorbatches_section" role="form" action="{{ url("programs/ennovatorbatches/$sections->id/update") }}" method="POST" novalidate enctype="multipart/form-data">
                            @csrf
                            {{method_field('POST')}}
                            <div class="row">
