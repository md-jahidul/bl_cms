        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <div class="card-body card-dashboard">
                        <form id="contact_section" role="form" action="{{ route('life.at.banglalink.contact.store') }}" method="POST" novalidate enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control" name="category_type" aria-invalid="false">
                                            ...
                                            <option value="connect_us_social">Connect Us At Social Media</option>
                                        </select>
                                </div>
