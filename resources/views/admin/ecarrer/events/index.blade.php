...
@endsection
@section('action')
    <a href="{{ url('life-at-banglalink/events/create') }}" class="btn btn-primary  round btn-glow px-2"><i class="la la-plus"></i>
        Add New Section
    </a>
@endsection
@section('content')
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <h4 class="menu-title pb-1"><strong>Events & Activities section</strong></h4>
                        ...
                        @foreach($sections as $key=> $section)
                            ...
                            <tr>
                                ...
                                <td class="text-center" width="22%">
                                    <a href="{{ url("life-at-banglalink/events/$section->id/edit") }}" role="button" class="btn btn-outline-success border-0"><i class="la la-pencil" aria-hidden="true"></i></a>

                                    @if( $section->is_default != 1 )
                                    <a href="{{ url("life-at-banglalink/events/destroy/$section->id") }}" role="button" class="btn btn-outline-success border-0" onclick="return confirm('Are you sure?');"><i class="la la-trash" aria-hidden="true"></i></a>
                                    @endif
