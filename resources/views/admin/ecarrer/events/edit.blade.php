...
@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{ url('life-at-banglalink/events') }}">Section List</a></li>
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    ...
                    <div class="card-body card-dashboard">
                        <form id="events_section" role="form" action="{{ url("life-at-banglalink/events/$sections->id/update") }}" method="POST" novalidate enctype="multipart/form-data">
                            @csrf
                            {{method_field('POST')}}
                            <div class="row">
