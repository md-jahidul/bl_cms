...
@endsection
@section('action')
    <a href="{{ url('programs/proiconbox/create') }}" class="btn btn-primary  round btn-glow px-2"><i class="la la-plus"></i>
        Add New Section
    </a>
@endsection
@section('content')
        ...
        <div class="card">
            <div class="card-content collapse show">
                <div class="card-body card-dashboard">
                    <h4 class="menu-title pb-1"><strong>Icon Box section</strong></h4>
