                        ...
                        <form class="form" method="POST"  id="uploadPaymentCard" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="message">Upload Payment Card List</label>
                                    <a href="{{ asset('sample-format/Easy-Peyment-Card.xlsx')}}" class="badge badge-info ml-2">Download Sample Format</a></br>
