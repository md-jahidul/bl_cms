...
{{--                            <th class="text-right">Action</th>--}}
                        ...
                        @foreach($campaignOffers as $campaignOffer)
                            ...
                            <tr data-index="{{ $campaignOffer->id }}" data-position="{{ $campaignOffer->campaign_order }}">
                                <td width="3%"><i class="icon-cursor-move icons"></i></td>
                                <td><img class="" src="{{ $campaignOffer->partner->company_logo }}" alt="Slider Image" height="50" width="50" /></td>
                                <td><img class="" src="{{ $campaignOffer->campaign_img }}" alt="Slider Image" height="50" width="50" /></td>
