        ...
        <div class="card">
            ...
            <div class="card-content collapse show">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <form novalidate class="form row"  action="{{ route('ad-tech.update', $adTech->id) }}"
                            ...
                            <div class="form-group col-12 mb-2 file-repeater">
                                <div class="row mb-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-12">
                                                <input type="radio" name="user_group_type" value="segment_wise" class="user_group_type" id="segment_wise"
                                                    {{ isset($adTech) && $adTech->user_group_type == "segment_wise" ? 'checked' : '' }} {{ isset($adTech) ? '' : 'checked' }}>
                                    ...
                                    <div class="form-group col-md-6 mb-2 {{ isset($adTech) && $adTech->user_group_type != "segment_wise" ? 'd-none' : '' }}" id="base_msisdn">
                                        ...
                                        <select id="base_groups_id" name="base_groups_id"
                                            ...
                                            @foreach ($baseMsisdnGroups as $key => $value)
                                                <option value="{{ $value->id }}"
                                                    {{ isset($adTech) && $adTech->base_groups_id == $value->id ? 'selected' : '' }}>{{ $value->title }}</option>
                                            @endforeach
                                        </select>
                                        <div class="help-block"></div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="status"
                                                    name="status">
                                                <option value="1" {{ $adTech->status == 1 ? 'selected' : "" }}> Active</option>
                                                <option value="0" {{ $adTech->status == 0 ? 'selected' : "" }}>Inactive</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-8">
                                        <img style="height:100px;width:200px" id="img_display"
                                             src="{{asset($adTech->image_url)}}" alt="" srcset="">
                                    </div>
