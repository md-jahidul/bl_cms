                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-2">
                                <div class="form-group">
                                    ...
                                    <input type="radio" name="status" value="1" id="input-radio-15" @if($question->status == 1) {{ 'checked' }} @endif>
                                    <label for="input-radio-15" class="mr-1">Active</label>

                                    <input type="radio" name="status" value="0" id="input-radio-16" @if($question->status == 0) {{ 'checked' }} @endif>
