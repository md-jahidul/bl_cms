                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($pageInfo->banner_web != "")
                                        <img src="{{ config('filesystems.file_base_url') . $pageInfo->banner_web }}" width="100%">
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-3 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($pageInfo->banner_mobile != "")
                                        <img src="{{ config('filesystems.file_base_url') . $pageInfo->banner_mobile }}" width="100%">
                                        @endif
                                    </div>
