        ...
        <li class="nav-item"><a href="#"><i class="la la-users"></i>
            ...
            <ul class="menu-content">
                <li class="{{ is_active_url('event-base-bonus/tasks')}}">
                    <a class="menu-item" href="{{ url('event-base-bonus/tasks') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-user"></i> Tasks</a>
                </li>
...
<!-- Campaign V2 Menu -->
<li class=" nav-item"><a href="#"><i class="la la-bullhorn"></i>
        <span class="menu-title" data-i18n="nav.templates.main">Campaigns V2</span></a>
    <ul class="menu-content">
        <li class="nav-item"><a href="#"><i class="la la-users"></i>
                <span class="menu-title" data-i18n="nav.templates.main">Event Base Bonus</span></a>
            <ul class="menu-content">
                <li class="{{ is_active_url('event-base-bonus/tasks')}}">
                    <a class="menu-item" href="{{ url('event-base-bonus/v2/tasks') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-user"></i> Tasks</a>
                </li>
                <li class="{{ is_active_url('event-base-bonus/campaigns')}}">
                    <a class="menu-item" href="{{ url('event-base-bonus/v2/campaigns') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-user"></i> Campaign</a>
                </li>
                <li class="{{ is_active_url('event-base-bonus/challenges')}}">
                    <a class="menu-item" href="{{ url('event-base-bonus/v2/challenges') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-user"></i> Challenge</a>
                </li>
                <li class="{{ is_active_url('event-base-bonus/tasks/analytics')}}">
