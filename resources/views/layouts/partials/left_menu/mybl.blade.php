...
@if(Auth::user()->type == 'mybl')
    ...
    <li class=" nav-item"><a href="#"><i class="la la-bullhorn"></i>
        ...
        <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="la la-hourglass"></i>
                    <span class="menu-title" data-i18n="nav.templates.main">Flash Hour</span></a>
                <ul class="menu-content">
                    <li class="{{is_active_url('flash-hour-campaign')}}">
                        <a class="menu-item" href="{{ route('flash-hour-campaign.index') }} "
                           data-i18n="nav.templates.vert.classic_menu">
                            <i class="la la-hourglass-half"></i> Campaign
                        </a>
                    </li>
                    <li class="{{is_active_url('flash-hour-campaign')}}">
                        <a class="menu-item" href="{{ route('flash-hour-campaign.index') }} "
                           data-i18n="nav.templates.vert.classic_menu">
                            <i class="la la-file-text"></i> Analytic Report
                        </a>
                    </li>
                </ul>
            </li>
