...
<li class=" nav-item"><a href="#"><i class="la la-cogs"></i>
        ...
        <li class="nav-item"><a href="#"><i class="la la-users"></i>
            ...
            <ul class="menu-content">
                ...
                <li class="{{ is_active_url('authorize/users')}}">
                    <a class="menu-item" href="{{ url('authorize/users') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-user"></i> User</a>
                </li>
                @endif
                @if( auth()->user()->can_view('Roles') )
                <li class="{{ is_active_url('authorize/roles')}}">
                    <a class="menu-item" href="{{ url('authorize/roles') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-cubes"></i> Role</a>
                </li>
                @endif
                @if( auth()->user()->can_view('Permissions') )
                <li class="{{ is_active_url('authorize/permissions')}}">
                    <a class="menu-item" href="{{ url('authorize/permissions') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-check-square"></i> Permission</a>
                </li>
                @endif
                @if( auth()->user()->can_view('AccessLog') )
                <li class="{{ is_active_url('access-logs')}}">
                    <a class="menu-item" href="{{ url('access-logs') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-lock"></i> Access Logs</a>
                </li>
                @endif
            </ul>
        </li>
    ...
    <ul class="menu-content">
        <li class=" {{ is_active_url('mybl-menu') }}">
            <a class="menu-item" href="{{ url('mybl-menu') }}" data-i18n="nav.templates.vert.classic_menu">
...
<li class="{{ is_active_url('mybl/core-product') }} nav-item"><a href="{{route('mybl.product.index')}}"><i class="la la-list"></i>
...
<li class=" nav-item"><a href="#"><i class="la la-feed"></i>
    ...
    <ul class="menu-content">
        ...
        <li class="{{ is_active_url('feeds/categories') }}{{ is_active_url('feeds/categories/create') }}">
            <a class="menu-item" href="{{ route('feeds.categories.index') }}" data-i18n="nav.templates.vert.classic_menu">
...
<li class="{{ is_active_url('target-wise-notification-report') }}">
    <a class="menu-item" href="{{ route('target-wise-notification-report.report') }}" data-i18n="nav.templates.vert.classic_menu">
        <i class="la la-comment-o"></i>Notification Report</a>
</li>
<li class="{{ is_active_url('purchase/from-notification/list')}}">
    <a class="menu-item" href="{{ url('purchase/from-notification/list') }}" data-i18n="nav.templates.vert.classic_menu">
...
{{--            <ul class="menu-content">--}}
{{--                <li class="{{ is_active_match('event-base-bonus/tasks')}}">--}}
{{--                    <a class="menu-item" href="{{ url('event-base-bonus/tasks') }}" data-i18n="nav.templates.vert.classic_menu"><i class="la la-cubes"></i> Tasks</a>--}}
{{--                </li>--}}
...
{{--        </li>--}}
        ...
        <li class="nav-item"><a href="#"><i class="la la-users"></i>
            ...
            <ul class="menu-content">
                <li class="{{ is_active_match('event-base-bonus/v2/tasks')}}">
                    <a class="menu-item" href="{{ url('event-base-bonus/v2/tasks') }}"
                       data-i18n="nav.templates.vert.classic_menu"><i class="la la-cubes"></i> Tasks</a>
                </li>
                <li class="{{ is_active_match('event-base-bonus/v2/campaigns')}}">
                    <a class="menu-item" href="{{ url('event-base-bonus/v2/campaigns') }}"
                       data-i18n="nav.templates.vert.classic_menu"><i class="la la-briefcase"></i> Campaign</a>
                </li>
                <li class="{{ is_active_match('event-base-bonus/v2/challenges')}}">
                    <a class="menu-item" href="{{ url('event-base-bonus/v2/challenges') }}"
                       data-i18n="nav.templates.vert.classic_menu"><i class="la la-history"></i> Challenge</a>
                </li>
                <li class="{{ is_active_match('event-base-bonus/v2/analytics') }}">
                    <a class="menu-item" href="{{ url('event-base-bonus/v2/analytics') }}"
        ...
        <li class="{{is_active_url('flash-hour-campaign')}}">
            <a class="menu-item" href="{{ route('flash-hour-campaign.index') }} " data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-list"></i> Flash Hour
            </a>
        </li>
        <li class="{{is_active_url('cash-back-campaign')}}">
            <a class="menu-item" href="{{ route('cash-back-campaign.index') }} " data-i18n="nav.templates.vert.classic_menu">
...
<li class=" nav-item"><a href="#"><i class="la la-cubes"></i>
    ...
    <ul class="menu-content">
        ...
        <li class="{{ is_active_url('subStore') }}{{ is_active_url('subStore/create') }}">
            <a class="menu-item" href="{{ route('subStore.index') }}" data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-comment-o"></i>Subcategory List</a>
        </li>


        <li class="{{ is_active_url('myblStore') }}{{ is_active_url('myblStore/create') }}">
            <a class="menu-item" href="{{ route('myblStore.index') }}" data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-comment-o"></i>Store List</a>
        </li>


        <li class="{{ is_active_url('appStore') }}{{ is_active_url('appStore/create') }}">
            <a class="menu-item" href="{{ route('appStore.index') }}" data-i18n="nav.templates.vert.classic_menu">
...
<li class=" nav-item"><a href="#"><i class="la la-puzzle-piece"></i>
    ...
    <ul class="menu-content">
        ...
        <li class="{{ is_active_url('mybl-slider/base-msisdn-list'). is_active_url('mybl-slider/base-msisdn-create')}}">
            <a class="menu-item" href="{{ route('myblslider.baseMsisdnList.index') }}" data-i18n="nav.templates.vert.classic_menu">
        ...
        <li class="{{ is_active_url('contextualcard-icons') . is_active_url('contextualcard/create')}}">
            <a class="menu-item" href="{{ route('contextualcard-icons.index') }}" data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-external-link-square"></i>Contextual Card Icons</a>
        </li>

        <li class="{{ is_active_url('banner-analytic')}}">
            <a class="menu-item" href="{{ route('banner-analytic.index') }}" data-i18n="nav.templates.vert.classic_menu">
...
<li class=" nav-item"><a href="#"><i class="la la-flask"></i>
    ...
    <ul class="menu-content">
        <li class="{{is_active_url('minute-pack/filter/create')}}">
            <a class="menu-item" href="{{ route('minute-pack.filter.create') }} " data-i18n="nav.templates.vert.classic_menu">
        ...
        <li class=" {{is_active_url('sms-pack/filter/create')}}">
            <a class="menu-item" href="{{ route('sms-pack.filter.create') }} " data-i18n="nav.templates.vert.classic_menu">
        ...
        <li class="{{ is_active_url('internetOffer')}} {{is_active_url('recharge-pack/filter/create')}}">
            <a class="menu-item" href="{{ route('recharge-pack.filter.create') }}" data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-globe"></i> Recharge Offer</a>
        </li>
        <li class="{{is_active_url('special-pack/filter/create')}}">
            <a class="menu-item" href="{{ route('special-pack.filter.create') }} " data-i18n="nav.templates.vert.classic_menu">
...
<li class=" nav-item"><a href="#"><i class="la la-comment"></i>
    ...
    <ul class="menu-content">
        <li class="{{ is_active_url('migrate-plan') }}{{ is_active_url('migrate-plan/create') }}">
            <a class="menu-item" href="{{ route('migrate-plan.index') }}" data-i18n="nav.templates.vert.classic_menu">
...
<li class="{{ is_active_url('/privacy-policy') }} nav-item"><a href="{{route('privacy-policy.show')}}"><i class="la la-paragraph"></i>
...
<li class=" nav-item"><a href="#"><i class="la la-gift"></i>
    ...
    <ul class="menu-content">
        ...
        <li class="{{ is_active_url('mybl/learn-priyojon') }}">
            <a class="menu-item" href="{{ route('learn-priyojon.show') }}" data-i18n="nav.templates.vert.classic_menu">
...
<li class=" nav-item"><a href="#"><i class="la la-question"></i>
    ...
    <ul class="menu-content">
        <li class=" {{is_active_url('faq/category')}}">
            <a class="menu-item" href="{{ route('faq.category.index') }} " data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-list"></i> Category List
            </a>
        </li>
        <li class="{{is_active_url('faq/questions')}}">
            <a class="menu-item" href="{{ route('faq.questions.index') }} " data-i18n="nav.templates.vert.classic_menu">
...
<li class=" nav-item"><a href="#"><i class="la la-comment"></i>
    ...
    <ul class="menu-content">
        <li class="{{ is_active_url(route('products-deep-link-report')) }}">
            <a class="menu-item" href="{{ route('products-deep-link-report') }}" data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-comment-o"></i>Product Deeplink</a>
        </li>

        <li class="{{ is_active_url('deeplink-analytic') }}">
            <a class="menu-item" href="{{ url('deeplink-analytic') }}" data-i18n="nav.templates.vert.classic_menu">
...
<li class=" nav-item"><a href="#"><i class="la la-users"></i>
    ...
    <ul class="menu-content">
        <li class=" {{is_active_url('deeplink/agent/deeplink/list')}}">
            <a class="menu-item" href="{{ route('deeplink.agent.list') }} " data-i18n="nav.templates.vert.classic_menu">
                <i class="la la-list"></i>Agent List
            </a>
        </li>
        <li class="{{is_active_url('agent/deeplink/report')}}">
            <a class="menu-item" href="{{ route('agent.deeplink.report') }} " data-i18n="nav.templates.vert.classic_menu">
