<div class="form-group col-md-6 {{ $errors->has('sliding_speed') ? ' error' : '' }}">
    ...
    <input type="text" name="other_attributes[sliding_speed]"  class="form-control" placeholder="Enter price info"
...
<div class="form-group col-md-6 {{ $errors->has('view_list_url') ? ' error' : '' }}">
    ...
    <input type="text" name="other_attributes[view_list_url]"  class="form-control" placeholder="Enter price info (Bangla)"
...
<div class="form-group col-md-6 {{ $errors->has('view_list_btn_text_en') ? ' error' : '' }}">
    ...
    <input type="text" name="other_attributes[view_list_btn_text_en]"  class="form-control" placeholder="Enter play store link"
