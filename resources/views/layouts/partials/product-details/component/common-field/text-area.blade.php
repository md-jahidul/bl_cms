<div class="form-group col-md-6 {{ $errors->has('description_en') ? ' error' : '' }}">
    ...
    <textarea name="description_en"  class="form-control" placeholder="Enter company name bangla">{{ isset($component->description_en) ? $component->description_en : '' }}</textarea>
...
<div class="form-group col-md-6 {{ $errors->has('description_bn') ? ' error' : '' }}">
    ...
    <textarea name="description_bn"  class="form-control" placeholder="Enter company name bangla">{{ isset($component->description_bn) ? $component->description_bn : '' }}</textarea>
    <div class="help-block"></div>
