<div class="form-group col-md-6 {{ $errors->has('editor_en') ? ' error' : '' }}">
    ...
    <textarea type="text" name="editor_en"  class="form-control" id="details" placeholder="Enter offer details in english">{{ isset($component->editor_en) ? $component->editor_en : '' }}</textarea>
...
<div class="form-group col-md-6 {{ $errors->has('editor_bn') ? ' error' : '' }}">
    ...
    <textarea type="text" name="editor_bn"  class="form-control" id="details" placeholder="Enter offer details in english" >{{ isset($component->editor_bn) ? $component->editor_bn : '' }}</textarea>
    <div class="help-block"></div>
