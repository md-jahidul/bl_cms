...
{{--    <textarea type="text" name="details_en"  class="form-control ckeditor" placeholder="Enter short details in english" cols="10" rows="10" id="details"--}}
...
{{--    <textarea type="text" name="details_bn"  class="form-control ckeditor" placeholder="Enter short details in Bangla" rows="5" id="details">{{ $productDetail->product_details->details_bn }}</textarea>--}}
{{--    <div class="help-block"></div>--}}
