...
<slot id="structure_1" class="{!! $productDetail->product_details->other_attributes['design_structure'] == 'structure_1' ? "style='display: block'" : "'style='display: none'" !!}"
      data-offer-type="structure_1">
    @include('layouts.partials.product-details.packages.start_up_offer_structure_1')
</slot>

<slot id="structure_2" class="{!! $productDetail->product_details->other_attributes['design_structure'] == 'structure_2' ? "style='display: block'" : "'style='display: none'" !!}"
      data-offer-type="structure_2">
