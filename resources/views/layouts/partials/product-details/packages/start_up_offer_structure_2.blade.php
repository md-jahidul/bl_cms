...
<div class="form-group col-md-6 {{ $errors->has('additional_details_en') ? ' error' : '' }}">
    ...
    <textarea name="other_attributes[additional_details_en]"  class="form-control" placeholder="Enter offer details in english" id="details">{{ !empty($productDetail->product_details->other_attributes['additional_details_en'])  }}</textarea>
...
<div class="form-group col-md-6 {{ $errors->has('additional_details_bn') ? ' error' : '' }}">
    ...
    <textarea name="other_attributes[additional_details_bn]"  class="form-control" placeholder="Enter offer details in english" id="details">{{ !empty($productDetail->product_details->other_attributes['additional_details_bn']) }}</textarea>
    <div class="help-block"></div>
...
<div class="form-group col-md-6 {{ $errors->has('bundle_expire_en') ? ' error' : '' }}">
    ...
    <input type="text" name="other_attributes[bundle_expire_en]"  class="form-control" placeholder="Enter offer details in english"
           value="{{ !empty($productDetail->product_details->other_attributes['bundle_expire_en']) }}" id="details">
    <div class="help-block"></div>
...
<div class="form-group col-md-6 {{ $errors->has('bundle_expire_bn') ? ' error' : '' }}">
    ...
    <input type="text" name="other_attributes[bundle_expire_bn]"  class="form-control" placeholder="Enter offer details in english"
           value="{{ !empty($productDetail->product_details->other_attributes['bundle_expire_bn']) }}" id="details">
    <div class="help-block"></div>
