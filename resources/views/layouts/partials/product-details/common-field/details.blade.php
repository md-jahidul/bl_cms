<div class="form-group col-md-6 {{ $errors->has('details_en') ? ' error' : '' }}">
    ...
    <textarea type="text" name="details_en"  class="form-control" placeholder="Enter short details in English" rows="5" id="summernote_editor"
...
<div class="form-group col-md-6 {{ $errors->has('details_bn') ? ' error' : '' }}">
    ...
    <textarea type="text" name="details_bn"  class="form-control" placeholder="Enter short details in English" rows="5" id="summernote_editor">{{ $productDetail->product_details->details_bn }}</textarea>
    <div class="help-block"></div>
