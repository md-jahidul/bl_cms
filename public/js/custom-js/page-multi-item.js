...
$(document).on('click', '#plus-image', function () {
    ...
    input += "<slot class='options-count'>"
    if(componentType === "galley_masonry"){
        input += '<div class="col-md-11 col-xs-6 ">\n' +
            ...
            '      <input type="hidden" name="componentData[' + total_option + '][image_one][group]" value="' + group_count + '"/>\n' +
        ...
        if(componentType === "hovering_card_component"){
            input += '<div class="col-md-11 col-xs-5 ">\n' +
                '<div class="form-group">\n' +
                ...
                '      <input type="hidden" name="componentData[' + total_option + '][image_two][group]"/ value="' + group_count + '">\n' +
                '      <span class="text-primary">Please given file type (.png, .jpg, svg)</span>\n' +
                ' </div>\n' +
                ' </div>';
        }
        input += '<div class="form-group col-md-6 ">\n' +
            ...
            '    <input type="hidden" name="componentData[' + total_option + '][title][group]" value="' + group_count + '">\n' +
            ...
            '    <input type="hidden" name="componentData[' + total_option + '][desc][group]" value="' + group_count + '">\n' +
            '<span class="help-block duplicate-error text-danger"></span>\n' +
            '</div>\n' +
            ...
            '    <input type="hidden" name="componentData[' + total_option + '][button][group]" value="' + group_count + '">\n' +
            '<span class="help-block duplicate-error text-danger"></span>\n' +
            '</div>\n' +
            ...
            '    <input type="hidden" name="componentData[' + total_option + '][button_link][group]" value="' + group_count + '">\n' +
            '<span class="help-block duplicate-error text-danger"></span>\n' +
            '</div>';
    }
    ...
    input += '<div class="form-group col-md-1 ">\n' +
        ...
        '   <i class="la la-trash remove-image btn-sm btn-danger mt-2"></i> \n' +
        '</div>';
    input += "</slot>"
