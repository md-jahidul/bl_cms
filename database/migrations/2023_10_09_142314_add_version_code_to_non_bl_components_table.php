...
class AddVersionCodeToNonBlComponentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('non_bl_components', function (Blueprint $table) {
            $table->bigInteger('android_version_code_min')->default(0)->after('is_fixed_position');
