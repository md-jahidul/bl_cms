...
class AddVesionCodeToGenericShortcutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::table('generic_shortcuts', function (Blueprint $table) {
            $table->bigInteger('android_version_code_min')->default(0)->after('is_default');
