...
class SmsPackFilterService
{
    ...
    {
        try {
            $filter = SmsPackFilter::find($request->id);
            $filter->delete();
            $response = [
                'status' => 'SUCCESS',
