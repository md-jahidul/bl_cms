...
class AmarOfferDetailsService
{
    ...
    {
        return $this->amarOfferDetailsRepository->findIn('type', array('data', 'voice', 'mix'));
    }

    public function findBannerImage()
    {
        return $this->amarOfferDetailsRepository->findOneByProperties(['type' => self::BANNER_IMAGE]);
    }
    ...
    public function bannerImageUpload($data)
    {
        ...
        if (!empty($data['banner_image_url'])) {
            ...
            $data['banner_image_url'] = $this->upload($data['banner_image_url'], 'assetlite/images/banner/amar_offer', $photoName);
        }
        ...
        if (!empty($data['banner_mobile_view'])) {
            ...
            $data['banner_mobile_view'] = $this->upload($data['banner_mobile_view'], 'assetlite/images/banner/amar_offer', $photoName);
        }
