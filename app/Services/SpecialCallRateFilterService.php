...
use App\Models\SpecialCallRateFilter;
 ...
 */
class SpecialCallRateFilterService
{
    ...
    {
        return new SpecialCallRateFilter();
    }
    ...
    {
        try {
            $filter = SpecialCallRateFilter::find($request->id);
            $filter->delete();
            $response = [
                'status' => 'SUCCESS',
