...
class BlogLandingPageController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('admin.blog.landing-page.component_create', compact('blogPosts'));
    }
    ...
    public function edit($id)
    {
        ...
        $blogPosts = $this->mediaPressNewsEventService->findByReferenceType(self::REFERENCE_TYPE);
        return view('admin.blog.landing-page.component_edit', compact('component', 'blogPosts'));
    }
    ...
    public function destroy($id)
    {
        ...
        return url('blog/landing-page-component');
    }
}
