...
class OfferCategory extends Model
{
    ...
    {
        return  (strtolower($type) == 'prepaid') ? $query->where('parent_id', 0) : $query->whereIn('alias', ['internet', 'voice', 'bundles', 'packages', 'others', 'postpaid_select', 'world_cup_offer'])->where('parent_id', 0);
    }
